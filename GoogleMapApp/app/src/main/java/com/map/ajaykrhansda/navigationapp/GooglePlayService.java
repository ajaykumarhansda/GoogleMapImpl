...
public class GooglePlayService implements LocationListener, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, LocationSource {
    ...
    public GooglePlayService(Activity mActivity) {
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (servicesConnected()) {
            ...
            if (currentLocation != null) {
                Log.e("GPS", "current location not null : " + currentLocation.toString());
                if (lupl != null) {
                    lupl.onLocationUpdate(currentLocation);
                }
            } else {
                Log.e("GPS", "current location is null");
    ...
    public void onConnectionFailed(ConnectionResult result) {
        Log.e("GPS", "onConnectionFailed..." + result.getErrorMessage());
...
//            mLocationRequest = null;
    ...
    public void setAutoModeLocationRequest(int valueInSeconds) {
        int interval = valueInSeconds * 1000;
        int fastestInterval = (valueInSeconds + Math.round(valueInSeconds / 2)) * 1000;
